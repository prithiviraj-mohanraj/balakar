...
import { Sparkles, Phone, ShieldCheck, Award, Building, Flame, ArrowRight } from "lucide-react";
...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FFFDF7] text-slate-900 selection:bg-[#D4AF37] selection:text-[#0F172A]">
      ...
      {/* Corporate Info */}
      <section className="relative py-20 border-b border-amber-100 bg-[#FAF9F6]">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div>
                ...
                <h2 className="text-2xl font-black uppercase tracking-tight text-[#0F172A] sm:text-4xl mt-1.5">
                  Sivakasi Sparklers Direct Supplier
                </h2>
              </div>
              
              <p className="text-xs sm:text-sm leading-relaxed text-slate-700">
                Balakar Sparklers Factory is a high-capacity manufacturing enterprise headquartered in <strong className="text-[#0F172A]">Alamarathupatti, Sivakasi</strong>, the fireworks capital of India. We design and produce high-performance, sparkling firework products distributed nationwide to wholesale markets, commercial shops, and festival distributors.
              </p>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="flex gap-3.5 p-3 rounded-2xl border border-amber-200/60 bg-white shadow-sm">
                  ...
                  <div>
                    <span className="text-xs sm:text-sm font-bold text-[#0F172A] uppercase tracking-wider block">Alamarathupatti Plant</span>
                    <p className="text-[11px] text-slate-600 mt-0.5 leading-relaxed">Modern production facility adhering strictly to safety regulations.</p>
                  </div>
                </div>
                
                <div className="flex gap-3.5 p-3 rounded-2xl border border-emerald-200/60 bg-white shadow-sm">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-600">
                    <ShieldCheck className="h-5 w-5" />
                  </span>
                  <div>
                    <span className="text-xs sm:text-sm font-bold text-[#0F172A] uppercase tracking-wider block">Green Certified Formulas</span>
                    <p className="text-[11px] text-slate-600 mt-0.5 leading-relaxed">Licensed by CSIR-NEERI for low environmental impact emissions.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              <div className="relative aspect-[4/3] rounded-3xl overflow-hidden border border-amber-200/80 shadow-md bg-white flex items-center justify-center p-4">
                <Image
              ...
              <div className="rounded-2xl border border-amber-200 p-5 bg-white flex items-center justify-between gap-4 shadow-sm">
                <div>
                  <span className="text-[10px] font-bold text-amber-700 uppercase tracking-widest block">Trademark Registration</span>
      ...
      <section className="relative overflow-hidden py-20 border-b border-amber-100 bg-[#FFFDF7]">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-5 order-last lg:order-first flex justify-center">
              <div className="relative overflow-hidden rounded-3xl border border-amber-200 bg-white p-8 shadow-xl max-w-sm w-full">
                <div className="relative aspect-square w-48 mx-auto flex items-center justify-center rounded-2xl bg-emerald-50/50 p-3 border border-emerald-200">
                  <Image
                ...
                <div className="mt-6 text-center">
                  ...
                  <span className="text-base font-bold text-[#0F172A] block mt-4 uppercase tracking-wider">CSIR-NEERI License</span>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full bg-emerald-50 border border-emerald-200 px-3 py-1 text-xs font-bold text-emerald-800 mb-4">
                  <Award className="h-3.5 w-3.5 text-emerald-600" />
                  <span>Licensed Green Fireworks</span>
                </div>
                <h2 className="text-2xl font-black tracking-tight text-[#0F172A] uppercase sm:text-4xl">
                  Eco-Friendly Production Standards
                </h2>
              </div>
              
              <p className="text-xs sm:text-sm leading-relaxed text-slate-700">
                Balakar Sparklers is dedicated to producing certified eco-friendly fireworks. In accordance with Supreme Court directives and government rules, our formulas have been fully validated by the <strong className="text-[#0F172A]">Council of Scientific and Industrial Research - National Environmental Engineering Research Institute (CSIR-NEERI)</strong>.
              </p>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="flex items-center gap-2 rounded-full bg-gradient-to-r from-[#D4AF37] to-[#F59E0B] px-8 py-3.5 text-xs font-extrabold uppercase tracking-widest text-[#0F172A] shadow-md hover:scale-[1.02] transition-all"
                >
