...
export default function TenCmPage() {
  ...
  const title = "10 CM Sparklers | Wholesale Sivakasi Manufacturer";
  const description = "Buy 10 CM Green Certified sparklers wholesale direct from Balakar Sparklers Factory in Sivakasi. Double-dipped steel wire core for high brightness.";
  ...
  const faqs = [
    {
      question: "What makes 10 CM sparklers a popular choice?",
      answer: "The 10 CM size offers an optimal balance between burning duration and radiant light emission, making it a top seller during Diwali."
    },
    {
      question: "What is the packing quantity for 10 CM sparklers?",
      answer: "Standard wholesale packaging includes 10 pieces per box and 40 boxes per master carton."
    }
  ];

  const orgSchema = getOrganizationSchema();
  const bizSchema = getLocalBusinessSchema();
  const prodSchema = getProductSchema("10 CM Sparklers", "/products/10cm-products.jpg", description, "BALAKAR-10CM");
  ...
  return (
    <div className="relative min-h-screen bg-[#05050A] text-slate-100 selection:bg-[#D4AF37] selection:text-black">
      ...
      <section className="relative overflow-hidden py-20 border-b border-white/10">
        <FireworkBackground type="hero" density={40} opacity={0.6} colorScheme="amber" />
        <GlowAtmosphere position="center" color="amber" intensity="medium" />
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7 flex flex-col gap-5 order-last lg:order-first">
              ...
              <h1 className="text-3xl font-black uppercase tracking-tight text-white sm:text-5xl">
                10 CM Sparklers <span className="text-[#D4AF37] gold-glow-text">Wholesale Sivakasi</span>
              </h1>
              <p className="text-xs sm:text-sm md:text-base text-slate-300 leading-relaxed">
                Buy premium-grade 10 CM sparklers direct from the source. Engineered with low-smoke chemistry at our Alamarathupatti factory under Phoenix Brand.
              </p>
            ...
            <div className="lg:col-span-5 flex justify-center w-full order-first lg:order-last">
              <div className="relative aspect-[4/3] w-full max-w-lg rounded-3xl overflow-hidden border border-white/15 shadow-2xl bg-black/60 p-2">
                <Image
                  ...
                  alt="10 CM Sparklers Catalog Packaging Box"
                  fill
      ...
      <section className="relative overflow-hidden py-20 border-b border-white/10 bg-[#08080C]">
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-10">
            <h2 className="text-xl font-extrabold uppercase text-white tracking-wider border-b border-white/10 pb-3">Introduction & Formulations</h2>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mt-4">
              Our 10 CM sparklers are manufactured under CSIR-NEERI Green License NE/TN/201-01/2019 using double-dipped steel wire core formulation for long burn times.
            </p>
          </div>
