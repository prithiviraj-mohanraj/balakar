...
export default function FifteenCmPage() {
  ...
  const title = "15 CM Sparklers | Event & Wedding Supplier Sivakasi";
  const description = "Buy 15 CM Grand Event Sparklers direct from Sivakasi manufacturer. High brightness, low smoke green certified chemistry for weddings and VIP events.";
  ...
  const faqs = [
    {
      question: "Why choose 15 CM sparklers for wedding photography?",
      answer: "The 15 CM sparkler offers extended burning time and dense crackling starbursts that look spectacular in wedding exit photography."
    }
  ];

  const orgSchema = getOrganizationSchema();
  const bizSchema = getLocalBusinessSchema();
  const prodSchema = getProductSchema("15 CM Sparklers", "/products/15cm-products.jpg", description, "BALAKAR-15CM");
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7 flex flex-col gap-5 order-last lg:order-first">
              ...
              <h1 className="text-3xl font-black uppercase tracking-tight text-white sm:text-5xl">
                15 CM Sparklers <span className="text-[#D4AF37] gold-glow-text">Event Collection</span>
              </h1>
              <p className="text-xs sm:text-sm md:text-base text-slate-300 leading-relaxed">
                Buy event-grade 15 CM sparklers direct from Balakar Sparklers Factory. Double-dipped coating ensuring 30% lower smoke and radiant starburst crackles.
              </p>
            ...
            <div className="lg:col-span-5 flex justify-center w-full order-first lg:order-last">
              <div className="relative aspect-[4/3] w-full max-w-lg rounded-3xl overflow-hidden border border-white/15 shadow-2xl bg-black/60 p-2">
                <Image
                  ...
                  alt="15 CM Sparklers Catalog Packaging Box"
                  fill
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-10">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mt-4">
              Our 15 CM sparklers are certified eco-friendly under CSIR-NEERI License NE/TN/201-01/2019, providing dense starburst crackles for stage lighting and wedding receptions.
            </p>
          </div>
