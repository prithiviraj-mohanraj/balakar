...
export default function ThirtyCmPage() {
  ...
  const title = "30 CM Giant Sparklers | Sivakasi Manufacturer";
  const description = "Buy extra-long 30 CM Giant Sparklers direct from Sivakasi manufacturer. 3+ minutes continuous burn time for wedding exits and mega celebrations.";
  ...
  const faqs = [
    {
      question: "What is the burn time of 30 CM giant sparklers?",
      answer: "Our 30 CM giant sparklers deliver over 3+ minutes of continuous golden starburst emission per stick."
    }
  ];

  const orgSchema = getOrganizationSchema();
  const bizSchema = getLocalBusinessSchema();
  const prodSchema = getProductSchema("30 CM Sparklers", "/products/30cm-products.jpg", description, "BALAKAR-30CM");
  ...
  return (
    <div className="relative min-h-screen bg-[#05050A] text-slate-100 selection:bg-[#D4AF37] selection:text-black">
      ...
      <section className="relative overflow-hidden py-20 border-b border-white/10">
        <FireworkBackground type="hero" density={45} opacity={0.7} colorScheme="gold" />
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7 flex flex-col gap-5 order-last lg:order-first">
              <span className="text-xs font-extrabold text-[#D4AF37] uppercase tracking-widest block">
                PHOENIX BRAND FLAGSHIP
              </span>
              <h1 className="text-3xl font-black uppercase tracking-tight text-white sm:text-5xl">
                30 CM Giant Sparklers <span className="text-[#D4AF37] gold-glow-text">Sivakasi Plant</span>
              </h1>
              <p className="text-xs sm:text-sm md:text-base text-slate-300 leading-relaxed">
                Buy extra-long 30 CM giant sparklers direct from Balakar Sparklers Factory. Producing 3+ minutes of continuous golden crackling starbursts.
              </p>
            ...
            <div className="lg:col-span-5 flex justify-center w-full order-first lg:order-last">
              <div className="relative aspect-[4/3] w-full max-w-lg rounded-3xl overflow-hidden border border-white/15 shadow-2xl bg-black/60 p-2">
                <Image
                  ...
                  alt="30 CM Sparklers Catalog Packaging Box"
                  fill
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-10">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mt-4">
              Our 30 CM giant sparklers are certified under CSIR-NEERI Green License NE/TN/201-01/2019, providing maximum visual impact for VIP wedding exits and major festival shows.
            </p>
          </div>
