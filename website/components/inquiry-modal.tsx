            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 max-h-[65vh] overflow-y-auto pr-1">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#FF6B00] to-[#F5B700] py-3 text-sm font-bold text-white shadow-md hover:shadow-[0_0_15px_rgba(255,107,0,0.4)] transition-all duration-200 disabled:from-zinc-350 disabled:to-zinc-400 cursor-pointer hover:scale-[1.01]"
                >
                  {isSubmitting ? (
                    <>
