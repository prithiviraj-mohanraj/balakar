          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-zinc-150 p-8 shadow-sm bg-white flex flex-col justify-between gap-6">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#FF6B00] to-[#F5B700] py-3.5 text-xs font-bold text-white shadow-md hover:shadow-[0_0_15px_rgba(255,107,0,0.4)] transition-all cursor-pointer hover:scale-[1.01]"
              >
